...
// Image imports for carousel in the About Page
...
export const LandingPageCarouselOneData = [
  {
    name: "c101",
    className: "img large",
    src: c101,
...
export const LandingPageCarouselTwoData = [
  {
    name: "c201",
    className: "img small",
    src: c201,
...
export const AboutPageCarouselData = [
  ...
  },
  {
    ...
    className: "img large last",
    src: c308,
    alt: "man crossing the street in a city",
  },
];
