export const serviceItemData = [
  {
    title: "01. Design",
    key: 0,
    alt: "plus / minus icon for design",
    message:
  ...
  },
  {
    title: "02. Sourcing",
    key: 1,
    alt: "plus / minus icon for sourcing",
    message:
  ...
  },
  {
    title: "03. Consulting",
    key: 2,
    alt: "plus / minus icon for consulting",
    message:
...

  {
    ...
    key: 3,
    alt: "plus / minus icon for development",
    message:
  ...
  },
  {
    ...
    key: 4,
    alt: "plus / minus icon for distribution",
    message:
